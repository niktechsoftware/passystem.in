                    ...
                    <div class="col-md-4 col-sm-6"> 
                      ...
                      <div class="col-md-4 col-sm-6"> 
                             ...
                             if($daboy->num_rows>0){
                               $daboy1=$daboy->row();
                           ?>
                           <h6 class="m-b-20 ">Delivery Incharge Detail -<br><br>Name:-<span class="text-primary text-uppercase"><?php echo  $daboy1->name."   [ ";?></span> With Lock : <?php echo $delivery->lock_id." ]";?> </h6>
                            <h6 class="text-uppercase ">Mobile Number :
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-info">
                                        ...
                                        <td>
                                            ...
                                            <h2 class="text-primary"  ><font color="blue"> <?php echo $delivery->desce;?></font></h2>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
